...
public class BoomerangV2 : RaycastController
{
    ...
    [SerializeField] private AnimationCurve _curveThrow;
    [SerializeField] private AnimationCurve _curveReturn;
    ...
    Vector3 CalculateBoomerangMovement()
    {
        if (isBoomeranging)
        {
            ...
            Vector3 newPos = Vector3.Lerp(startPoint, endPoint, isReturning ? _curveReturn.Evaluate(_current) : _curveThrow.Evaluate(_current));
